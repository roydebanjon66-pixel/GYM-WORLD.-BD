document.addEventListener('DOMContentLoaded', () => {
    ...
    const goalData = {
        weight: { subtitle: "🏋️ Premium Fitness & Strength Training Center – Dhaka", title: "LOSE WEIGHT <br><span>FAST & EFFECTIVELY</span>", desc: "Train with confidence at GYM WORLD BD using expert-guided weight loss programs, structured cardio workouts, and premium fitness equipment designed to burn fat fast and keep it off for good." },
        muscle: { subtitle: "🏋️ Premium Fitness & Strength Training Center – Dhaka", title: "BUILD STRENGTH <br><span>BEYOND LIMITS</span>", desc: "Build elite muscle and raw power with science-backed hypertrophy and strength training programs at GYM WORLD BD — crafted for both beginners and advanced athletes." },
        fit: { subtitle: "🏋️ Premium Fitness & Strength Training Center – Dhaka", title: "TRANSFORM YOUR BODY <br><span>TRANSFORM YOUR LIFE</span>", desc: "Equipped with modern gym equipment, experienced coaches, and a powerful training atmosphere, GYM WORLD BD provides everything needed for a complete body transformation journey." }
    };
